...
public class HumanPlayer extends Player
{
    ...
    public void mark(String[][] gameBoard){
        ...
        int row, column;
        while(true){
            System.out.println("\nPlayer 1, What row do you want to mark. Please give your answer as a number");
            row = scanner.nextInt() - 1;
            System.out.println("Player 1, What column do you want to mark. Please give your answer as a number");        
